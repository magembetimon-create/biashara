...
urlpatterns=[
    ...
    path('payment-statement', views.payment_statement_page, name='payment_statement_page'),
    path('payment-statement/data', views.payment_statement_data, name='payment_statement_data'),
