...
urlpatterns=[
    ...
    path('compound_orders_data', views.compound_orders_data, name='compound_orders_data'),
    path('compound_order_direct_sale', views.compound_order_direct_sale, name='compound_order_direct_sale'),
    path('compound_order_assign_waiter', views.compound_order_assign_waiter, name='compound_order_assign_waiter'),
    ...
    path('waiter_settings',views.waiter_settings, name='waiter_settings'),
        path('waiter_set_pin',views.waiter_set_pin, name='waiter_set_pin'),
            path('waiter_set_pin_device',views.waiter_set_pin_device, name='waiter_set_pin_device'),
            path('waiter_device_settings',views.waiter_device_settings, name='waiter_device_settings'),
