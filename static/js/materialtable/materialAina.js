 ...
 let idadi_item=0,zilizopo=0,thamani=0,mauzo_tegemeo=0,num=0
     ...
     if(Categs.state.length>0){ 
         ...
         num+=1
             ...
             <td class="text-capitalize" > <a href="/production/MaterialAina?f=${itm.kundi_id}"> ${itm.kundi}</a></td>
         ...
         trp+=` 
             ...
             <div class="d-flex">
                 ...
                 <a href="/production/MaterialReg?f=${itm.id}"  class="btn btn-default text-primary btn-sm  " > 
