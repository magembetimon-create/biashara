...
$('body').on('focus','.suggest-holder input', function(){
 ...
 function filterInputData(dt){
    ...
    const {pos,searchi} = dt,itmsi = Items.state.filter(m=>m.material&&(m.complete || !m.produced)) , 
                     ...
                     if(Number(colored[l].bidhaa__bidhaa__idadi_jum)>1 && ((Number(colored[l].idadi)/Number(colored[l].bidhaa__bidhaa__idadi_jum)>=1) || add) ){
                          ...
                          coloredone+=`  
                             ...
                             <div class="row" style="font-size:10px">
                                ...
                                <div class="col-5">
                                    <strong>${Number(colored[l].idadi).toFixed(2)}</strong> 
                                </div>
                             </div>
      ...
      <div class="centerItem bg-light" id="imgplace${pos}">
       ...
       <td>
        ...
        <div class="input-group">
          ...
          id = "search${pos}"
          data-itm = 0
          class="form-control border0 darkblue text-capitalize weight500 muhimu-b-kununua-zilizopo suggest-prompt${pos} suggest-prompt input-data latoFont" />
    ...
    let url=$(this).attr("action"),
      //  edit=$(this).data("edit"),
       // bill=$(this).data("bill"),
        ...
        date = moment($('#kuanzia_tarehe').val()).format(),
        
        nw = 0,
        valu=Number($(this).data('value')) || 0
        reasoni = Number($('#adjReason').val()) || 0,
        desc = $('#maelezoProd').val(),
    ...
    success: function (respo) {
        ...
        if(respo.success){
            toastr.success(lang(respo.msg_swa,respo.msg_eng), 'Success Alert', {timeOut: 7000});
                 ...
                 location.replace(`/production/productionUsedItems?pr=${respo.pr}`)
