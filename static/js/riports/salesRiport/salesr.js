...
function AddRow(){
        ...
        if(theData.state.length>0){        
            ...
            let Df = i => !i.online,  Lf = i=>i.online,Na = ByU(),Tawi=branch(),Wvat = withVat()
               ...
               n+=1 
                ...
                let tha = dtI.reduce((a,b)=> a + (b.thamani*(b.idadi-b.returned)/b.uwiano),0),
                    uzo =  dt.reduce((a,b)=> a + Number(b.amount),0),
                ...
                tr+=`
                    ...
                    <td class=" weight600">${floatValue(tha)}</td>
                    <td class=" weight600">${floatValue(uzo)}</td>
                    <td class="brown weight600">${floatValue(lipwa)}</td>`
      ...
      let  dt =  theData.state.filter(i=>i.id===val)
           ...
           if(dt.length>0){
                let  theDT = dt[0],
                    ...
                    Df = i => !i.online,  Lf = i=>i.online,Tawi =branch(), Wvat = withVat(),
                    //  BRANCH SELECTOR FILTER
                ...
                let    usrs = [... new Set(ankara.map(b=>b.Na))],
                        ...
                        const tha = Number(itms.reduce((a,b)=> a + (b.thamani*(b.idadi-b.returned)/b.uwiano),0)),
                            sal = Wvat==0?Number(ankara.reduce((a,b)=> a + Number(b.amount),0)):Number(itms.reduce((a,b)=> a + Number(b.bei*(b.idadi-b.returned)),0)),
                           ...
                           let btn = `  <button title="${lang('Hifadhi Riport','Save Riport')}" class="smallMadebuttons border0 text-primary float-right smallFont " data-toggle="modal" data-target="#saveRiportTime" >
                             ...
                             duraTitle =  theDT.txt   
                            $('#riporttitle').html(`${lang('Ufupisho: Ripoti ya Mauzo','Summary: Sales Riport ')}, ${theDT.txt} ${btn}`)                           

                            switch (Number(n)) {
                                case 1:
                                    placeInvo(ankara,itmO,{from:theDT.from,to:theDT.To})
                                    break;
                                case 2:
                                    placeItems(itms,val)
                                    break;
 ...
 function placeInvo(ankara,itms,muda){
    ...
    $('#howMany').text(`${dates.length}/${days}`)
     ...
     if(LoC){
                ...
                //Draw new Chart................................................................................................................./
                let title = `<h6 class="py-2" >${lang(`Takwimu ya Mauzo kwa kila `,`Sales Statistics on each `)} ${days<=31?lang('Siku','Day'):lang('Mwezi','Month')}, ${duraTitle}<h6/>`
                ...
                var data= {
                        ...
                        datasets: [{
                           ...
                           ,{
                                ...
                                // notice the gap in the data and the spanGaps: false
                                data:days<=31?amounts.map(a=>Number(a.faida-a.vat).toFixed(FIXED_VALUE)):mAmount.map(m=>m.faida-m.vat),
                                spanGaps: false,
                            }
                            ]
                        };
                        ...
                        if(Number(Vallow())){
                            data.datasets.push({
                                ...
                                // notice the gap in the data and the spanGaps: false
                                data:days<=31?amounts.map(a=>Number(a.vat).toFixed(FIXED_VALUE)):mAmount.map(m=>m.vat),
                                spanGaps: false,
                            })
                        }
                ...
                <thead>
                    <tr class="smallFont ">
                       ...
                       td+= `
                        ...
                        <th> ${lang('Faida','Profit')}<span class="text-primary latoFont">(${currencii})</span></th>
                ...
                amo.reverse().forEach(a=>{
                    ...
                    td+=`<tr>
                     ...
                     if(Vallow()){
                      ...
                      td+=`<td ${(a.faida-a.vat)<0?'class="brown weight600"':''}>${floatValue(a.faida-a.vat)}</td>
    ...
    let title = `<h6 class="py-2" >${lang(`Orodha ya Mauzo kwa kila `,`Sales List on each `)} ${days<=31?lang('Siku','Day'):lang('Mwezi','Month')}, ${duraTitle}<h6/>`
 ...
 function   placeItems(itms,val){
     let LoC = Number($('#riportChatRist .btn-secondary').data('riport')),
         ...
         if(LoC){
             ...
             //Draw new Chart................................................................................................................./
             let title = `<h6 class="py-2 " >${lang(`Takwimu ya Mauzo ya kila Bidhaa `,`Sales Statistics on each Item  `)}, ${duraTitle}<h6/>`
             $('#theDataPanel').html(`${title} <div class="table-responsive" ><canvas style="${window.outerWidth>800?'max-height:85vh !important':'max-height:70vh !important'} "  id="myChartC"></canvas></div>`);
             ...
             var data= {
                     ...
                     datasets: [{
                        ...
                        ,{
                             ...
                             // notice the gap in the data and the spanGaps: false
                             data:bidhaa.map(a=>Number(a.sale-(a.tha-a.vat)).toFixed(FIXED_VALUE)),
                             spanGaps: false,
                         }
                         ]
                     };
                     ...
                     if(Vallow()){
                        data.datasets.push({
                            ...
                            // notice the gap in the data and the spanGaps: false
                            data:bidhaa.map(a=>Number(a.vat).toFixed(FIXED_VALUE)),
                            spanGaps: false,
                        })
                    }
         ...
         <thead>
             <tr class="smallFont ">
               ...
               td+=`<th> ${lang('Faida','Profit')}<span class="text-primary latoFont">(${currencii})</span></th>`
 ...
 function   placeCategory(itms,val){
     let aina = Categs.state,
         ...
         if(LoC){
             ...
             //Draw new Chart................................................................................................................./
             let title = `<h6 class="py-2 " >${lang(`Takwimu ya Mauzo ya kila Aina ya Bidhaa `,`Sales Statistics on each Item Category  `)}, ${duraTitle}<h6/>`
 ...
 `   
 let title = `<h6 class="py-2 " >${lang(`Orodha ya Mauzo ya kila Aina ya Bidhaa `,`Sales List on each Item Category  `)}, ${duraTitle}<h6/>`
 $('#theDataPanel').html(title+td)
 $('#SoldItems').DataTable();
         }
 ...
 function   placeGroups(itms,val){
    ...
    if(LoC){
        ...
        //Draw new Chart................................................................................................................./
        let title = `<h6 class="py-2 " >${lang(`Takwimu ya Mauzo ya kila Kundi la Bidhaa `,`Sales Statistics on each Items Group  `)}, ${duraTitle}<h6/>`
        $('#theDataPanel').html(`${title}<div class="table-responsive" ><canvas style="${window.outerWidth>800?'max-height:85vh !important':'max-height:70vh !important'} "  id="myChartC"></canvas></div>`);
...
`   
let title = `<h6 class="py-2 " >${lang(`Orodha ya Mauzo ya kila Kundi la Bidhaa `,`Sales List on each Item Group  `)}, ${duraTitle}<h6/>`
$('#theDataPanel').html(title+td)
$('#SoldItems').DataTable();
    }
...
function   placeAlipia(pay){
    ...
    <thead>
        <tr class="smallFont ">
            ...
            <th> ${lang('Malipo ya Mauzo','Sales Payment')}<span class="text-primary latoFont">(${currencii})</span> </th>
...
`   
let title = `<h6 class="py-2 " >${lang(`Orodha ya Malipo ya Mauzo kwa kila Akaunti ya Malipo`,`Sales Payments List on each Payment Account  `)}, ${duraTitle}<h6/>`
$('#theDataPanel').html(title+td)
$('#SoldItems').DataTable();
    }
...
function SalesPerson(invo){
  let ankara = invo.ankara,
      ...
      if(LoC){
          ...
          //Draw new Chart................................................................................................................./
          let title = `<h6 class="py-2 " >${lang(`Takwimu ya  Mauzo kwa kila Mtumiaji Aliyeuza`,`Sales  Statistics on each Sales Person  `)}, ${duraTitle}<h6/>`
          $('#theDataPanel').html(`${title} <div class="table-responsive" ><canvas style="${window.outerWidth>800?'max-height:85vh !important':'max-height:75vh !important'} "  id="myChartC"></canvas></div>`);
          ...
          var data= {
                  ...
                  datasets: [{
                      ...
                      spanGaps: true,
                          ...
                          // notice the gap in the data and the spanGaps: false
                          data:salesP.map(a=>Number(a.tha).toFixed(FIXED_VALUE)),
                          spanGaps: false,
                      }
                     ,{
                          label: lang("Faida","Profit"),
                          ...
                          // notice the gap in the data and the spanGaps: false
                          data:salesP.map(a=>Number(a.amount-(a.tha+a.vat)).toFixed(FIXED_VALUE)),
                          spanGaps: false,
                      }
                      ]
                  };
                  if(Vallow()){
                     data.datasets.push({
                         ...
                         // notice the gap in the data and the spanGaps: false
                         data:salesP.map(a=>Number(a.vat).toFixed(FIXED_VALUE)),
                         spanGaps: false,
                     })
                  }
                  var options = {
                      ...
                      xAxes:[
                          {
                              ticks:{
                               ...
                               scaleLabel: {
                              display:true,
                              labelString:lang('Afisa Mauzo','Sales Person'),
                              fontSize: 13 
                          }
                          }
                      ]            
          ...
          options: options
            ...
            tr = `<table id="table-Invoices" class="table-hover table table-bordered smallFont" style="width:100%">
                <thead>
                    <tr class="smallerFont ">
                        ...
                        if(Vallow()){
                            tr+=`<th> VAT <span class="text-primary latoFont">(${currencii})</span> </th>`
                        }      

                        tr+=`<th> ${lang('Faida','Profit')}<span class="text-primary latoFont">(${currencii})</span></th> 
            ...
            salesP.reverse().forEach(a=>{
                ...
                tr+= `<tr> 
                    ...
                    `
                        if(Vallow()){
                            tr+=`<td>${floatValue(a.vat)}</td>`
                        }      

                        tr+=`
                        <td ${(profit)<0?'class="brown weight600"':'class="weight600"'}>${floatValue(profit)}</td>
            ...
            let title = `<h6 class="py-2 " >${lang(`Orodha ya  Mauzo kwa kila Mtumiaji Aliyeuza`,`Sales List on each Sales Person  `)}, ${duraTitle}<h6/>`
             ...
             let ft = i=>  moment(i.tarehe).startOf('day').format() >= moment(muda.from).startOf('day').format()&& moment(i.tarehe).endOf('day').format() <= moment(muda.to).endOf('day').format() ,
              ...
              tr = `<table id="table-Invoices" class="table-hover table table-bordered smallFont" style="width:100%">
                    ...
                    ankara.reverse().forEach(a=>{
                        n+=1
                        let itmz =itmsOg.filter(n=>n.mauzo_id== a.id),
                        ...
                        tr+= `<tr> 
                          ...
                          `
                                if(Vallow()){
                                    tr+=`<td>${floatValue(vat)}</td>`
                                }      
         
                               tr+=`
                               <td ${(faida)<0?'class="brown weight600"':'class="weight600"'}>${floatValue(faida)}</td>
                          <td>
                    ...
                    let d1= moment(muda.from).format('YYYY-MM-DD'),
                       ...
                       title = `<h6 class="py-2 " >${lang(`Orodha ya Ankara za Mauzo`,`Sales Invoices List on`)},<span class="darkblue"> ${dur}</span><h6/>`
...
function viewItembByBranch(vl){
    ...
    $('#SoldItems').DataTable();
        ...
        $('#theDataPanel').prepend(`<h6 id="itmTitle" class="py-3" data-itm=${id} data-val=${val} data-num=1 >${lang('Mauzo ya','Sales on')} <i class="darkblue text-capitalize">${itms[0].bidhaaN}</i>  ${lang('Kwa kila Tawi','In each branch')}</h6>`)
...
function viewCategoryByBranch(vl){
    ...
    $('#SoldItems').DataTable();
        ...
        $('#theDataPanel').prepend(`<h6 id="itmTitle" class="py-3" data-itm=${id} data-val=${val} data-num=2 >${lang('Mauzo ya','Sales on')} <i class="darkblue text-capitalize">${aina[0].aina}</i>  ${lang('Kwa kila Tawi','In each branch')}</h6>`)
...
function viewGroupByBranch(vl){
    ...
    $('#SoldItems').DataTable();
        ...
        $('#theDataPanel').prepend(`<h6 id="itmTitle" class="py-3" data-itm=${id} data-val=${val} data-num=3 >${lang('Mauzo ya','Sales on')} <i class="darkblue text-capitalize">${aina[0]?.mahitaji}</i>  ${lang('Kwa kila Tawi','In each branch')}</h6>`)
