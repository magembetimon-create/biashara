...
urlpatterns=[
    ...
    path('registeredItemsRegisterBulk',views.registeredItemsRegisterBulk, name='registeredItemsRegisterBulk'),
    path('searchOtherBranchItems',views.searchOtherBranchItems, name='searchOtherBranchItems'),
